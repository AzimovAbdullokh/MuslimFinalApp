...
import com.example.ui_core.databinding.GenericSnackbarBinding
import com.example.ui_core.databinding.GenericSnackbarTimerBinding
import com.example.ui_core.extensions.layoutInflater
...
open class GenericSnackbar private constructor() {
    ...
    companion object {
        ...
        private fun assembleSnackbar(
            ...
            val binding = GenericSnackbarBinding.inflate(rootView.context.layoutInflater())
        ...
        private fun assembleSnackbar(
            ...
            val binding =
                GenericSnackbarTimerBinding.inflate(rootView.context.layoutInflater())
            val snackbar = inflateSnackBar(
                customLayout = binding.root,
                rootView = rootView,
