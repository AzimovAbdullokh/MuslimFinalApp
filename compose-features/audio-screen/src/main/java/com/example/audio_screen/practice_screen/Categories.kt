...
import com.example.audio_screen.R
...
internal fun Categories(
    ...
    Row(
        ...
        Icon(
            painter = painterResource(
                id = com.example.ui_core.R.drawable.pause_icon
            ),
            contentDescription = null,
            modifier = modifier
    ...
    Row(
        ...
        Switch(
            ...
            colors = SwitchDefaults.colors(
                checkedThumbColor = colorResource(id = com.example.ui_core.R.color.blue),
                uncheckedThumbColor = colorResource(id = com.example.ui_core.R.color.gray_silver)
            ),
        )
    }
}