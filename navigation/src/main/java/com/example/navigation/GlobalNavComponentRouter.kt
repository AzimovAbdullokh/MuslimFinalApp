...
import com.example.common_impl.ActivityRequired
import com.example.navigation.navigation.NavComponentRouter
import com.example.navigation.navigation.RouterHolder
...
class GlobalNavComponentRouter @Inject constructor(
     ...
     */
    fun launch(@IdRes destinationId: Int, args: java.io.Serializable? = null) = invoke { requireRealRouter().launch(destinationId, args) }
    ...
    fun startTabs(startTabDestinationId: Int? = null) = invoke {
        requireRealRouter().switchToTabs(destinationsProvider.provideMainTabs(),
