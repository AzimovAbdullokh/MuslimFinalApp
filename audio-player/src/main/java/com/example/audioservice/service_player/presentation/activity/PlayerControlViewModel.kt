...
import com.example.utils_core.extensions.createSharedFlowAsSingleLiveEvent
...
class PlayerControlViewModel @Inject constructor() : ViewModel() {
    ...
    private val _startRenderContent = createSharedFlowAsLiveData<AudioNasheedsUi?>()
    val startRenderContent: SharedFlow<AudioNasheedsUi?> = _startRenderContent.asSharedFlow()
    ...
    fun startRenderContent(audioBook: AudioNasheedsUi?) {
